  ...
  <div className="container mx-auto flex justify-between items-center py-4 px-4">
    ...
    <div className="flex items-center space-x-4">
      ...
      <select
        ...
        className="px-4 py-2 rounded-full bg-white text-gray-700 border 
                   border-gray-300 shadow-sm hover:shadow-md hover:bg-gray-50 
      ...
      <div className="relative">
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-full
                     bg-green-100 hover:bg-green-200 text-green-700 font-medium
                     shadow-sm hover:shadow-md transition-all"
        >
      ...
      <div className="relative">
        <button
          ...
          className="w-10 h-10 rounded-full bg-gray-200 overflow-hidden 
                     ...
                     border border-gray-300 hover:border-green-500 transition"
        >
          <img
            src={user?.avatar ||
        ...
        {showProfileMenu && (
          <div className="absolute right-0 mt-3 w-56 bg-white p-3 rounded-2xl 
                          shadow-xl ring-1 ring-gray-200 z-20 animate-fade-in">
            ...
            {!user ? (
              <>
                <button
                  ...
                  className="flex items-center gap-2 w-full px-3 py-2 
                             text-gray-700 hover:bg-gray-100 rounded-xl transition"
                >
                  🔑 Sign In
                </button>
                <button
                  ...
                  className="flex items-center gap-2 w-full px-3 py-2 
                             text-green-600 hover:bg-green-50 rounded-xl font-semibold transition"
                >
                  ✨ Sign Up
                </button>
              </>
              ...
              <>
                ...
                <button
                  ...
                  className="flex items-center gap-2 w-full px-3 py-2 
                             text-red-600 hover:bg-red-50 rounded-xl font-semibold transition"
                >
                  🔐 Sign Out
                </button>
              </>
